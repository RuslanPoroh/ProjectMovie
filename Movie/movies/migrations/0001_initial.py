    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Информация об актере или режиссере')),
                ('image', models.ImageField(upload_to='actors/', verbose_name='Фото актера или режиссера')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default='XX-XXI век', verbose_name='Дата релиза')),
                ('country', models.CharField(max_length=50, verbose_name='Страна')),
                ('world_premiere', models.DateField(default='XX-XXI век', verbose_name='Примьера в мире')),
