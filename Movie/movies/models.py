...
class Actor(models.Model):
    ...
    description = models.TextField("Информация об актере или режиссере")
    image = models.ImageField("Фото актера или режиссера", upload_to="actors/")
...
class Movie(models.Model):
    ...
    year = models.PositiveSmallIntegerField("Дата релиза", default='XX-XXI век')
    country = models.CharField("Страна", max_length=50)
    directors = models.ManyToManyField(Actor, verbose_name='режиссер', related_name="film_director")
    actors = models.ManyToManyField(Actor, verbose_name="актеры", related_name="film_actor")
    genres = models.ManyToManyField(Genre, verbose_name="жанры")
    world_premiere = models.DateField("Примьера в мире", default='XX-XXI век')
